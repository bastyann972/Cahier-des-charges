...
Arborescence d'une application e-commerce :
Accueil ("/")
...
Route : /cart
Composant : Cart
Page de compte utilisateur ("/account")

Route : /account
Composant : UserAccount
Page de confirmation de commande ("/order-confirmation")
